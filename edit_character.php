...
//			}
	...
	<body>
		...
		<form name="form" method="post">
			...
			<input type="number" name="weight" value="1" min="1" max="1000">
			
			<label for="height">Height:</label>
			<input type="number" name="height" value="1" min="1" max="100">
			
			<label for="age">Age:</label>
			<input type="number" name="age" value="1" min="1" max="1000">
			...
			<input type="number" name="hit_points" value="0" min="0" max="1000">
